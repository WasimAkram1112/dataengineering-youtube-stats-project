...
AWSGlueDataCatalog_node1779895477400 = glueContext.create_dynamic_frame.from_catalog(database="de-youtube-raw-db", push_down_predicate="region in ('ca','gb','us')", table_name="raw_stats", transformation_ctx="AWSGlueDataCatalog_node1779895477400")

# Script generated for node Drop Null Fields
DropNullFields_node1780026843603 = drop_nulls(glueContext, frame=AWSGlueDataCatalog_node1779895477400, nullStringSet={"", "null"}, nullIntegerSet={-1}, transformation_ctx="DropNullFields_node1780026843603")

# Script generated for node Change Schema
ChangeSchema_node1779895874117 = ApplyMapping.apply(frame=DropNullFields_node1780026843603, mappings=[("video_id", "string", "video_id", "string"), ("trending_date", "string", "trending_date", "string"), ("title", "string", "title", "string"), ("channel_title", "string", "channel_title", "string"), ("category_id", "long", "category_id", "bigint"), ("publish_time", "string", "publish_time", "string"), ("tags", "string", "tags", "string"), ("views", "long", "views", "bigint"), ("likes", "long", "likes", "bigint"), ("dislikes", "long", "dislikes", "bigint"), ("comment_count", "long", "comment_count", "bigint"), ("thumbnail_link", "string", "thumbnail_link", "string"), ("comments_disabled", "boolean", "comments_disabled", "boolean"), ("ratings_disabled", "boolean", "ratings_disabled", "boolean"), ("video_error_or_removed", "boolean", "video_error_or_removed", "boolean"), ("description", "string", "description", "string"), ("region", "string", "region", "string")], transformation_ctx="ChangeSchema_node1779895874117")

# Script generated for node Amazon S3
EvaluateDataQuality().process_rows(frame=ChangeSchema_node1779895874117, ruleset=DEFAULT_DATA_QUALITY_RULESET, publishing_options={"dataQualityEvaluationContext": "EvaluateDataQuality_node1779889768993", "enableDataQualityResultsPublishing": True}, additional_options={"dataQualityResultsPublishing.strategy": "BEST_EFFORT", "observations.scope": "ALL"})
AmazonS3_node1779896614991 = glueContext.write_dynamic_frame.from_options(frame=ChangeSchema_node1779895874117, connection_type="s3", format="glueparquet", connection_options={"path": "s3://de0526-youtube-stats-useast1-cleaned/youtube/raw-statistics/", "partitionKeys": ["region"]}, format_options={"compression": "snappy"}, transformation_ctx="AmazonS3_node1779896614991")
